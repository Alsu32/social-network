import {followAPI, userAPI, UsersResponseType} from "../api/api";
...
export const setUsers = (users:Array<UsersResponseType>) => {return {type: "SET-USERS", users} as const}
